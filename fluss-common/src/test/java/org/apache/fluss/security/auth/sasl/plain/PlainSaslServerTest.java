...
public class PlainSaslServerTest {
    ...
    @Test
    public void testImpersonationNotGranted() {
    ...
    @Test
    public void testImpersonationWithWildcard() throws SaslException {
        // impersonate_userA = "*" allows userA to impersonate any user
    ...
    @Test
    public void testImpersonationWithAllowedList() throws SaslException {
        // impersonate_userB grants "userC, userD": entries are trimmed and the target
        // user does not need to be defined via a user_<name> option
    ...
    @Test
    public void testImpersonationNotInAllowedList() {
        assertThatThrownBy(
    ...
    @Test
    public void testImpersonationWithInvalidPassword() {
